...
public class VecUtils {
    ...
    public static Vec3d random() {
        return vec3d(-1 + 2 * rand.nextDouble(), -1 + 2 * rand.nextDouble(), -1 + 2 * rand.nextDouble());
    }
    public static Vec3i vec3d2Vec3i(Vec3d vec){return new Vec3i(vec.x,vec.y,vec.z);}
    public static Vec3d vec3i2Vec3d(Vec3i vec){return new Vec3d(vec.getX(),vec.getY(),vec.getZ());}
    ...
    public static Vec3d entityPos(Entity e) {
        return vec3d(e.posX, e.posY + (isThePlayer(e) ? -1.6 : 0.0), e.posZ);
    }

    public static Vec3d entityHeadPos(Entity e) {
        return vec3d(e.posX, e.posY + (isThePlayer(e) ? 0 : e.getEyeHeight()), e.posZ);
    }
