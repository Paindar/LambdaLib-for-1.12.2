...
public class Motion3D {
    ...
    public Motion3D(Vec3d posVec, double moX, double moY, double moZ) {
        this(posVec.x, posVec.y, posVec.z, moX, moY, moZ);
    }
    
    public Motion3D(Vec3d pos, Vec3d vel) {
        this(pos, vel.x, vel.y, vel.z);
    }
     ...
     * @param entity
     * @param offset
     * @param dirFlag true: use head facing direction; false: use motion
     */
