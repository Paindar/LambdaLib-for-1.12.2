...
public class HudUtils {
    ...
    {
        Tessellator.getInstance().getBuffer().begin(glMode, DefaultVertexFormats.POSITION_TEX);
    }
    ...
    public static void colorRect(double x, double y, double width, double height) {
        ...
        Tessellator t = Tessellator.getInstance();
        startDrawingQuads();
        addVertex(x + 0,        y + height, zLevel);
        addVertex(x + width, y + height, zLevel);
        addVertex(x + width, y + 0,       zLevel);
        addVertex(x + 0,        y + 0,        zLevel);
        t.draw();
    ...
    public static void drawRectOutline(double x, double y, double w, double h, float lineWidth) {
        ...
        w += 2 * lw;
        h += 2 * lw;
        addVertex(x, y, zLevel);
        addVertex(x, y + h, zLevel);
        addVertex(x + w, y + h, zLevel);
        addVertex(x + w, y, zLevel);
        t.draw();
    ...
    public static void drawGradientRect(int x0, int y0, int x1, int y1, int color1, int color2) {
        ...
        Tessellator t = Tessellator.getInstance();
        startDrawingQuads();
        t.getBuffer().color(f1, f2, f3, f);
        addVertex(x1, y0, -90D);
        addVertex(x0, y0, -90D);
        t.getBuffer().color(f5, f6, f7, f4);
        addVertex(x0, y1, -90D);
        addVertex(x1, y1, -90D);
        t.draw();
