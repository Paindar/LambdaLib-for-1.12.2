...
public class ItemRegistration extends RegistrationFieldSimple<RegItem, Item> {
    ...
    protected void register(Item value, RegItem anno, String field) throws Exception {
        ...
        if(value instanceof ItemBlock){
            LambdaLib.log.warn("ItemBlock doesn't need to register manually, if you are sure it has been connected with some Block by @RegBlock. ");
            LambdaLib.log.warn("LambdaLib will still register "+field+".");
        }
